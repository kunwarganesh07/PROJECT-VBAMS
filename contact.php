                ...
                <div class="card-body" style="margin-left:10px">
                    ...
                    $data = $query->fetch_assoc(); ?>
                                ...
                                <div class="single-address">
                                    <div class="icon locationicon"><i class="fa-solid fa-location-dot mt-2" style="margin-top:5px"></i></div>
                                ...
                                <div class="single-address">
                                    ...
                                    <div class="icon-text">
                                        <p style="margin-top:15px;">Phone : + <?php echo $data['MobileNumber'];?>
                                        </p>
                                    </div>
                                </div>
                                <!-- single address end -->
                                <!-- single address start -->
                                <div class="single-address">
                                    <div class="icon emailicon"><i class="fa-regular fa-envelope" style="margin-top:5px"></i></div>
                                    <div class="icon-text">
